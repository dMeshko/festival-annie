...
public class MainActivity extends AppCompatActivity
    ...
    private void populateList(){
        ...
        artist.setName("Annie");
        artist.setImageUrl("https://img00.deviantart.net/9526/i/2012/247/f/f/annie_league_of_legends_by_khaylie-d5dl5xx.jpg");
        artists.add(artist);

        artist = new Artist();
        artist.setName("Mannie");
        artist.setImageUrl("https://i0.wp.com/allhiphop.com/wp-content/uploads/2012/08/79821329.jpg");
        artists.add(artist);
    }
